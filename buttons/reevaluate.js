    ...
    async execute(client, interaction, MessageEmbed, Formatters, db) {
        ...
        try {
            ...
            embed = new MessageEmbed()
                ...
                .setColor("RANDOM")
                .addField("Input:", Formatters.codeBlock("javascript", limit(code)), false)
                .addField("Output:", Formatters.codeBlock("javascript", limit(results)), false)
                .addField("Type:", Formatters.codeBlock("javascript", typeOf), false)
                .addField("Prototype:", Formatters.codeBlock("javascript", tree(evaled)), false)
                .setFooter({
            ...
            embed = new MessageEmbed()
                .setTitle("Evaluation Results")
                .setColor("#FF0000")
                .addField("Input:", Formatters.codeBlock("javascript", code), false)
                .addField("Output:", Formatters.codeBlock("javascript", limit(err)), false)
                .addField("Type:", Formatters.codeBlock("javascript", "Error"), false)
                .setFooter({
                    iconURL: interaction.user.displayAvatarURL(),
                    text: `Executed by ${interaction.user.username}, in about ${Math.floor(Date.now() - interaction.createdAt)} milliseconds`
                });
