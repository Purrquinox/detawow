    ...
    async execute(client, interaction, MessageEmbed, Formatters, db) {
        ...
        try {
            ...
            embed = new MessageEmbed()
                ...
                .setColor("RANDOM")
                .addField("Input:", Formatters.codeBlock("javascript", limit(code)), inline)
                .addField("Output:", Formatters.codeBlock("javascript", limit(results)), inline)
                .addField("Type:", Formatters.codeBlock("javascript", typeOf), inline)
                .addField("Prototype:", Formatters.codeBlock("javascript", tree(evaled)), inline)
                .setFooter({
            ...
            embed = new MessageEmbed()
                .setTitle("Evaluation Results")
                .setColor("#FF0000")
                .addField("Input:", Formatters.codeBlock("javascript", code), inline)
                .addField("Output:", Formatters.codeBlock("javascript", limit(err)), inline)
                .addField("Type:", Formatters.codeBlock("javascript", "Error"), inline)
                .setFooter({
                    iconURL: interaction.user.displayAvatarURL(),
                    text: `Executed by ${interaction.user.username}, in about ${Math.floor(Date.now() - interaction.createdAt)} milliseconds`
                });
